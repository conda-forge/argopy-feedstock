...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/argopy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10139&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/argopy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `argopy` can be installed with:

```
conda install argopy
```

It is possible to list all of the versions of `argopy` available on your platform with:
